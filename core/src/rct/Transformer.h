...
public:
	 ...
	 */
	bool setTransform(const Eigen::Affine3f& transform,
	 ...
	 *
	 */
	Eigen::Affine3f lookupTransform(const std::string& target_frame,
			const std::string& source_frame, boost::uint64_t time) const;
	...
	Eigen::Affine3f lookupTransform(const std::string& target_frame,
			...
			boost::uint64_t source_time, const std::string& fixed_frame) const;
